...
<head>
	...
	<title>Envío contraseña generada</title>
	<style type="text/css">
		p{
			font-family: arial;
			letter-spacing: 1px;
		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>Bienvenido(a) a nuestro sistema <?=NOMBRE_EMPRESA;?>.</p>
					<p>Accede a tu cuenta con tus credenciales: </p>
					<p>Usuario: <strong><?= $data['email']; ?></strong></p>
					<p>Contraseña: <strong><?= $data['newPassword']; ?></strong></p>					
					<p>Por favor ingresar al link y loguearse con tus credenciales y cambiar la contraseña. </p>
					<p class="x_text_white">
					<a href="<?= BASE_URL . "/login"; ?>" target="_blank" class="x_button_link x_link_blue">Login de acceso</a>
					</p>
					<br>
